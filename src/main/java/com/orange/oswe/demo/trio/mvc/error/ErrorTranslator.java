 ...
 *   <li>retrieves the http state from a {@link ResponseStatus} annotation (if present in the handled {@link Exception} class),
 *   <li>or else assumes it is an internal error ({@code 500} http state).
 * </ol>
 */
